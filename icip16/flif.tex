...
%It is somewhat more complicated and can result in slightly larger files, but i
...
otherwise it
%if it is continuous, then the guess 
...
%it is a good guess if the local area of the image happens to contain a smooth color gradient.
...
possible colors from $2^{24} = 16\,777\,216$ to only $\sim$ 4 million.} % $4\,007\,551$.}
and at 90\% quality.
...
%For one corpus (16-bit photographs), JPEG 2000 performed best; f
